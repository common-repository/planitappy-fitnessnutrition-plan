 ...
 * @subpackage Pia_WorkoutPlan/admin/partials
 */ 
...
<div class="wrap">
	    ...
	    <img style="display:block; margin-top: 20px;" <?php echo($logo); ?>  ><h1 style="display:block;">PlanItAppy Fitness/Nutrition Plan Settings</h1>
	    ...
	    <div id="Instructions" class="tabcontent" style="display: none;">
		        ...
		        <div class="tab" style="margin-top: 20px;">
		            ...
		            <button class="tablinks2" id="workoutPlansButton" onclick="secondInstructions(event, 'workoutPlans')">2: Create Fitness/Nutrition Plans</button>
		        ...
		        <div id="workoutPlans" class="tabcontent2" style="display: none;">
		
		            <h2 style="margin-top: 20px;"><b>Create your fitness/nutrition plan(s)</b></h2>
		            <p>Once you have logged in or signed up, you need to create the fitness/nutrition plans that will appear on your website. <br>To do that, go to "Online Training" > "Plan" > "Create Dedicated Fitness Plan" in the top menu.</p>
		            
		            <p><a href="https://planitappy.com/classic/en/Faq/faq/315/how-do-i-create-a-fitness-plan.html" target="_blank">Here is a video tutorial</a> on how to do the rest.</p>

		            <p style="padding-bottom: 100px;">When you have created one or more classes, you will see them listed in the "Test your Store URL" tab.</p>
		        </div>
		        
		        
		        <div id="TestURL" class="tabcontent2" style="display: none;">
			         <p>If you have correctly saved your store URL and created a fitness/nutrition plan, you will see them appear below, from which your clients can add them to their calendar to start them or download them.</p>
			         ...
			         <h2>Fitness / Nutrition Plan Wizard:</h2>
			         <?php  echo (pia_workoutplan_display()); ?>
			    </div>
		        ...
		        <div id="shortcode" class="tabcontent2" style="display: none;">
		            ...
		            <p>The plugin shortcode is a small line of code that you use to display the Fitness/Nutrition Plan Wizard. You can place it anywhere on your site - in Posts, Pages, Widgets, even the Footer if you really want! To avoid any errors when pasting it into a Post or Page, make sure to be in the Text editor before pasting it:</p>
